<template>
  <div>
    ...
    <div class="breadcrumb">
        <div class="container">
            <h2>
                <router-link to="/index">首页</router-link>&gt;<router-link to="/news_details">公司动态</router-link>
            </h2>
        </div>
    </div>
    <!--页面主体-->
    <div class="main container">
        <div class="news_details">
            ...
            <div class="news_content">
                ...
                <img src="/static/news_imgs/01.jpg" alt=""/>
                ...
                <img src="/static/news_imgs/02.jpg" alt=""/>
